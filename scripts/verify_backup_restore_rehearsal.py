...
from shared.mesh_runtime.backup_restore import (
    BACKUP_RESTORE_VERIFICATION_VERSION,
    verify_backup_restore_rehearsal,
)


EXPECTED_BACKUP_RESTORE_VERIFICATION_SCHEMA = "mesh.backup_restore_verification.v1"
