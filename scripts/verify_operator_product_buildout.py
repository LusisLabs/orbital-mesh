...
REQUIRED_DOC_MARKERS = [
    ...
    "Docker Dynamic MCP is modeled as a session-only dry-run bridge",
    "`code-mode` stays blocked",
...
REQUIRED_PRODUCT_UI_MARKERS = [
    ...
    "praxis.managed-dry-run-runtime.v1",
    "Docker Dynamic MCP dry-run",
    "Docker Dynamic MCP as a session-only dry-run bridge",
