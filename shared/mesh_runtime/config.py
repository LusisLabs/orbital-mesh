...
DEFAULT_AUTHENTICATED_INGRESS_PROOF_PATH = DEFAULT_STATE_DIRECTORY / "proofs" / "authenticated-ingress-deployment-proof.json"
DEFAULT_DESIGN_PARTNER_PACKET_PATH = DEFAULT_STATE_DIRECTORY / "proofs" / "design-partner-packet.json"
