...
DEFAULT_STATE_DIRECTORY = Path(__file__).resolve().parents[2] / ".mesh-runtime-state"
DEFAULT_WEB_ASSET_PATH = Path(__file__).resolve().parents[2] / "web" / "dist"
...
class RuntimeConfig:
    ...
    def from_env(cls) -> "RuntimeConfig":
        return cls(
            ...
            goose_command_timeout_seconds=int(os.getenv("MESH_GOOSE_COMMAND_TIMEOUT_SECONDS", "180")),
