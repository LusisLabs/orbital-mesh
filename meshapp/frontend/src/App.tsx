...
export default function App() {
  ...
  return (
    <div className={`mesh-console-shell mesh-agent-console ${rightRailOpen ? "drawer-open" : ""}`}>
      ...
      <a className="skip-link" href="#mesh-main-content">Skip to operator workspace</a>
      ...
      <div className="mesh-console-main">
        ...
        <main id="mesh-main-content" className="mesh-page" data-testid={`mesh-view-${activeView}`}>
          {activeView === "overview" ? (
            <OverviewDashboard
