...
"[project]/meshapp/frontend/src/landing/AsciiFlowCanvas.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/meshapp/frontend/src/landing/FractureRingCanvas.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/meshapp/frontend/src/api.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function resolveBaseUrl() {
    ...
    if (configured) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$meshapp$2f$frontend$2f$src$2f$product$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeLoopbackBaseUrl"])(configured, window.location);
    }
    if (window.location.protocol === "http:" || window.location.protocol === "https:") {
        return window.location.origin;
    }
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$meshapp$2f$frontend$2f$src$2f$product$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeLoopbackBaseUrl"])(DEFAULT_API_BASE_URL, window.location);
}
...
"[project]/meshapp/frontend/src/lib/format.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/meshapp/frontend/src/lib/labyrinth.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$meshapp$2f$frontend$2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/meshapp/frontend/src/lib/format.ts [app-client] (ecmascript)");
;
function buildLabyrinthJourneys({ runs, researchSessions, watchers, activeRunId, activeResearchSessionId }) {
    const runJourneys = runs.map((run)=>({
            ...
            title: run.scenario_key ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$meshapp$2f$frontend$2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["humanize"])(run.scenario_key) : "Manual run",
            status: run.status,
            summary: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$meshapp$2f$frontend$2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["humanize"])(run.stage)} - ${run.latest_event_sequence} events`,
    ...
    const researchJourneys = researchSessions.map((session)=>({
            ...
            summary: session.research_intelligence ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$meshapp$2f$frontend$2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["humanize"])(session.research_intelligence.classification) : session.has_final_report ? "Final report ready" : "Research in progress",
...
function buildLabyrinthCrossings({ run, scenarioAnalysis, evidenceGraph, memoryCrystallization, watchers }) {
    ...
    (evidenceGraph?.nodes ?? []).filter((node)=>node.type === "subdecision" || node.type === "scenario_analysis").forEach((node)=>{
        crossings.push({
            ...
            journey_id: journeyId,
            type: node.type,
            label: String(node.label ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$meshapp$2f$frontend$2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["humanize"])(node.type)),
...
function crossingFromEvent(event) {
    return {
        ...
        label: (0, __TURBOPACK__imported__module__$5b$project$5d2f$meshapp$2f$frontend$2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["humanize"])(event.event_type),
...
"[project]/meshapp/frontend/src/lib/runGraph.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=meshapp_frontend_src_0cnkat8._.js.map