module.exports = [
"[project]/meshapp/frontend/src/landing/AsciiFlowCanvas.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const FractureRingCanvas = ({ progress })=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$6_$40$playwright$2b$test$40$1$2e$60$2e$0_react$2d$dom$40$19$2e$2$2e$6_react$40$19$2e$2$2e$6_$5f$react$40$19$2e$2$2e$6$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("canvas", {
        ...
        fileName: "[project]/meshapp/frontend/src/landing/FractureRingCanvas.tsx",
        lineNumber: 241,
        columnNumber: 5
    }, ("TURBOPACK compile-time value", void 0));
};
const __TURBOPACK__default__export__ = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$6_$40$playwright$2b$test$40$1$2e$60$2e$0_react$2d$dom$40$19$2e$2$2e$6_react$40$19$2e$2$2e$6_$5f$react$40$19$2e$2$2e$6$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["memo"])(FractureRingCanvas);
}),
"[project]/meshapp/frontend/src/api.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$meshapp$2f$frontend$2f$src$2f$product$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/meshapp/frontend/src/product/api.ts [app-ssr] (ecmascript)");
;
const DEFAULT_API_BASE_URL = ("TURBOPACK compile-time value", "http://127.0.0.1:8799") ?? "http://127.0.0.1:8787";
...
function operatorIdentityHeaders() {
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        return envOperator && envRoles ? {
            "X-Mesh-Operator": envOperator,
            "X-Mesh-Roles": envRoles
        } : {};
    }
    //TURBOPACK unreachable
    ;
    const params = undefined;
    const operatorId = undefined;
...
"[project]/meshapp/frontend/src/lib/format.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/meshapp/frontend/src/lib/labyrinth.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function buildLabyrinthJourneys({ runs, researchSessions, watchers, activeRunId, activeResearchSessionId }) {
    const runJourneys = runs.map((run)=>({
            ...
            title: run.scenario_key ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$meshapp$2f$frontend$2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["humanize"])(run.scenario_key) : "Manual run",
            status: run.status,
            summary: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$meshapp$2f$frontend$2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["humanize"])(run.stage)} - ${run.latest_event_sequence} events`,
    ...
    const researchJourneys = researchSessions.map((session)=>({
            ...
            summary: session.research_intelligence ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$meshapp$2f$frontend$2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["humanize"])(session.research_intelligence.classification) : session.has_final_report ? "Final report ready" : "Research in progress",
...
function buildLabyrinthCrossings({ run, scenarioAnalysis, evidenceGraph, memoryCrystallization, watchers }) {
    ...
    (evidenceGraph?.nodes ?? []).filter((node)=>node.type === "subdecision" || node.type === "scenario_analysis").forEach((node)=>{
        crossings.push({
            ...
            journey_id: journeyId,
            type: node.type,
            label: String(node.label ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$meshapp$2f$frontend$2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["humanize"])(node.type)),
...
function crossingFromEvent(event) {
    return {
        ...
        label: (0, __TURBOPACK__imported__module__$5b$project$5d2f$meshapp$2f$frontend$2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["humanize"])(event.event_type),
...
"[project]/meshapp/frontend/src/lib/runGraph.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function buildRunGraph(events, selectedEventId) {
    ...
    const nodes = events.map((event)=>{
        ...
        return {
            ...
            sourcePosition: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$xyflow$2b$system$40$0$2e$0$2e$76$2f$node_modules$2f40$xyflow$2f$system$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Position"].Right,
            targetPosition: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$xyflow$2b$system$40$0$2e$0$2e$76$2f$node_modules$2f40$xyflow$2f$system$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Position"].Left,
            style: {
...
//# sourceMappingURL=meshapp_frontend_src_13v1gvz._.js.map