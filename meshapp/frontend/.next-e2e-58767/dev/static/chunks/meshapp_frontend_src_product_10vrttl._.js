...
const DEFAULT_API_BASE_URL = ("TURBOPACK compile-time value", "http://127.0.0.1:58766")?.trim() || "http://127.0.0.1:8787";
...
function resolveBaseUrl() {
    ...
    const configured = ("TURBOPACK compile-time value", "http://127.0.0.1:58766")?.trim();
    if (configured) {
