module.exports = [
"[project]/src/landing/AsciiFlowCanvas.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/landing/FractureRingCanvas.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/labyrinth.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function buildLabyrinthJourneys({ runs, researchSessions, watchers, activeRunId, activeResearchSessionId }) {
    const runJourneys = runs.map((run)=>({
            ...
            title: run.scenario_key ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["humanize"])(run.scenario_key) : "Manual run",
            status: run.status,
            summary: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["humanize"])(run.stage)} - ${run.latest_event_sequence} events`,
    ...
    const researchJourneys = researchSessions.map((session)=>({
            ...
            summary: session.research_intelligence ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["humanize"])(session.research_intelligence.classification) : session.has_final_report ? "Final report ready" : "Research in progress",
...
function buildLabyrinthCrossings({ run, scenarioAnalysis, evidenceGraph, memoryCrystallization, watchers }) {
    ...
    (evidenceGraph?.nodes ?? []).filter((node)=>node.type === "subdecision" || node.type === "scenario_analysis").forEach((node)=>{
        crossings.push({
            ...
            journey_id: journeyId,
            type: node.type,
            label: String(node.label ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["humanize"])(node.type)),
...
function crossingFromEvent(event) {
    return {
        ...
        label: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["humanize"])(event.event_type),
...
"[project]/src/lib/runGraph.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=src_0_r1d~0._.js.map