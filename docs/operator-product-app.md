...
- `internal-packages/mesh-contracts/src/generated/operator-product.ts` (generated by `pnpm --dir internal-packages/mesh-contracts run generate`)
- `internal-packages/mesh-contracts/scripts/generate-contracts.mjs`
