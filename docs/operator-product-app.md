...
| `pnpm run auth-provider:checkpoint` | Writes the ignored redacted P0 checkpoint with local evidence complete, explicit reused-stack provenance, latest capture-attempt blockers, and `live_provider_proof_missing` as the remaining external blocker. |
...
| `pnpm run test:focused` | Passed 206 Python tests and 35 frontend tests. |
