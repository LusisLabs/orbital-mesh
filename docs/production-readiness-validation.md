...
- Current-head release provenance is incomplete for the checked-out head. After
  the repo-local commit step, strict provenance generation reports
  `git.dirty=false` and still lacks `image_digest`, `base_image_digests`,
