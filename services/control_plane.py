...
class RunCoordinator:
    ...
    def run_mesh_brain_live_serving_smoke(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        artifact_refs = {
            ...
            "mesh_brain_live_smoke_gate": mesh_brain_artifact_ref(
        ...
        status = "completed" if release_decision in {"canary", "promote"} else "blocked" if release_decision == "block" else "manual_review"
        run_record = {
            "tenant_id": tenant_id,
            "stage": stage,
            "status": status,
