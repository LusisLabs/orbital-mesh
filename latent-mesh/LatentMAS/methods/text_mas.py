...
from utils import extract_gsm8k_answer, normalize_answer, extract_markdown_python_block, run_with_timeout, trim_text_to_token_budget
import argparse
import pdb
        ...
        for agent in self.agents:
            prompt_contexts = [
                trim_text_to_token_budget(
                    ...
                    context,
                    getattr(self.args, "text_mas_context_tokens", 2048),
                    keep="tail",
                )
