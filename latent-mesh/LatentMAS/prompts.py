...
def _context_window(context: str, args=None) -> str:
    limit = getattr(args, "text_mas_context_length", -1) if args is not None else -1
...
def build_agent_messages_sequential_text_mas(role: str, question: str, context: str = "", method=None, args=None):
    ...
    # Token budgeting is applied before prompt construction; this keeps the legacy char limit safe.
    ctx = _context_window(context, args)
