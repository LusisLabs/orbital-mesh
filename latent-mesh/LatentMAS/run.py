...
def main():
    ...
    parser.add_argument("--text_mas_context_length", type=int, default=-1, help="Legacy TextMAS character context limit; set -1 to disable.")
    parser.add_argument("--text_mas_context_tokens", type=int, default=2048, help="TextMAS token budget for prior-agent context passed into later agents; set -1 to disable.")
